...
namespace HardWareInfoAcquire.DataHelper
{
    class SQLiteHelper
    {
        public static String pathStr = System.IO.Directory.GetCurrentDirectory();
        //读取配置文件
        public static string connectionString = @"Data Source=" + pathStr + @"\sqlite\shenhuablister.db";
